...
ActiveRecord::Schema.define(version: 2019_12_13_133659) do
  ...
  create_table "programs", force: :cascade do |t|
    ...
    t.string "db_status"
    t.string "state"
    t.boolean "created_db_myself", default: false
  ...
  create_table "retranslators", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "admin_user_id"
    t.index ["admin_user_id"], name: "index_retranslators_on_admin_user_id"
  end
