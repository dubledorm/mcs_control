...
describe DatabaseTools do
  ...
  describe 'create database' do
    ...
    it { expect{create_database(ActiveRecord::Base.connection, 'chicken_mc_1' )}.to_not raise_error }
  ...
  describe 'drop database' do
    ...
    it 'should not generate exception if database exists' do
      create_database(ActiveRecord::Base.connection, 'chicken_mc_1' )
      expect{drop_database(ActiveRecord::Base.connection, 'chicken_mc_1' )}.to_not raise_error ActiveRecord::StatementInvalid
    end
